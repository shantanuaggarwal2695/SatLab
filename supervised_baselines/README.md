**CNN**: A simple convolutional neural network script with different parameters like batch size, lr, etc. Please change the parameters with different use-cases
